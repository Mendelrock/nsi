...
<?php include_once 'include_import_export_incomp_post.php'; ?>

<? include_once 'incompatibilite_post_cud.php'; ?>

<form method="post" name ="incompatibilite_post_gestion" action="incompatibilite_post_result.php?ACTE=1" target="resultat">
