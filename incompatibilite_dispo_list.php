...
<?php include_once 'include_import_export_incomp_dispo_list.php'; ?>

<form method="post" name ="toile" action="incompatibilite_dispo_list_result.php?ACTE=1" target="resultat">
         ...
         <table class="menu_haut">
            <tr>
               ...
               <? if(droit_utilisateur("toile")){
                   echo "<td class='externe'><A class='externe' href='incompatibilite_dispo_detail.php'>Créer une incompatibilité</A></td>";
                  }
                ?>
            </tr>
         </table>
