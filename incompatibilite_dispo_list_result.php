...
?>
      <tr id="<? echo $z * 100?>">
         <?
               $bgcolor=alternat($z);	
         ?>
               <td class='resultat_list' bgcolor='<? echo alternat($z) ?>'><a class='resultat' href='incompatibilite_dispo_detail.php?Id_incompatibilite=<? echo $resultat->f('Id_incompatibilite') ?>' target='droite'><? echo $resultat->f('Produit') ?></a></td>
