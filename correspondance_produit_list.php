...
<form method="post" name ="affaire" action="correspondance_produit_list_result.php?ACTE=1" target="resultat">
         ...
         <table class="menu_haut">
            <tr>
               ...
               <? if(droit_utilisateur("article")){?>
                   <td class='externe'><A class='externe' href='#' onclick="showFenetreCorrespondance('2','creer_correspondance_produit.php');">Créer une correspondance</A></td>
                   <? }
                ?>
            </tr>
         </table>
