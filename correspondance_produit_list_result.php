...
?>
      <tr>
         <td class='resultat_list' bgcolor='<? echo alternat($z) ?>'><a class='resultat' href='#' onclick="showFenetreCorrespondance('1',<? echo "'creer_correspondance_produit.php?site_produit=". urlencode($resultat->f('site_produit'))."'" ?>);"><? echo $resultat->f('site_produit') ?></a></td>
...
if($z){
   ...
   echo "<tr>";
   echo"<td class='resultat_footer'>Cliquer sur Site produit pour ouvrir une correspondance</td>";
