...
?>
            <tr>
               ...
               <td class="resultat_list" align="right" bgcolor="<? echo $couleur ?>"><? echo $tableau['1']['nb'] ?></td>
               <td class="resultat_list" align="right" bgcolor="<? echo $couleur ?>"><? echo @number_format($tableau['1']['Prix'],0,'',' ') ?></td>
...
?>
         ...
         <table class="resultat">
            <tr>
               ...
               <td class="resultat_tittle" colspan = 2><A style="text-decoration: none;color:gray">Signatures</A></td>
