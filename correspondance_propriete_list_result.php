...
?>
      <tr>
         <td class='resultat_list' bgcolor='<? echo alternat($z) ?>'><a class='resultat' href='#' onclick="showFenetreCorrespondance('1',<? echo "'creer_correspondance_propriete.php?site_propriete=". urlencode($resultat->f('site_propriete'))."&nsi_produit=". urlencode($resultat->f('nsi_produit'))."'" ?>);"><? echo $resultat->f('site_propriete') ?></a></td>
