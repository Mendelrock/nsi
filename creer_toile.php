  	  	 ...
  	  	 foreach ($liste_enregistrement as $i => $record) {
				...
				if($record[typerecord]=="entete"){
  	     	   	if($Id_toile){	
				   	...
				   	selecteur_enrouleur_exterieur,selecteur_enrouleur_interieur,selecteur_coffre_exterieur,selecteur_coffre_interieur,
				   	selecteur_film_exterieur,selecteur_film_interieur,
				   	selecteur_coussin, selecteur_paroi,couleur,gamme,orientation,
				     	amotif_raccordable,
				     	amotif_ajustable) values (
				     '$lb_toile_atelier',
				     '$lb_toile_sr',
				     '$selecteur_rideau',
				     '$selecteur_doublure',
...
<FORM method=post name=formulaire action=creer_toile.php?ACTE=1>
...
<table class="requeteur">
   <tr>
      ...
      <td class="requet_left"><? drop_down_droit("O","", "orientation", "", "", $orientation,false, "article","N", "neutre|oppose", "neutre|oppose");?></td>
   </tr>
   ...
   <tr>
      ...
      <td></td>
      <td class="requet_left"><input type="checkbox" class='checkbox' name="selecteur_enrouleur_interieur" <? if($selecteur_enrouleur_interieur==1) echo "checked='yes'" ?> value="1">Enrouleur Interieur</td>
      <td></td>
      <td></td>
   </tr>
   <tr>
      ...
      <td ></td>
      <td></td>
      <td class="requet_left"><input type="checkbox" class='checkbox' name="selecteur_enrouleur_exterieur" <? if($selecteur_enrouleur_exterieur==1) echo "checked='yes'" ?> value="1">Enrouleur Exterieur</td>
      <td></td>
      <td></td>
   </tr>
   ...
   <tr>
      ...
      <td></td>
      <td class="requet_left"><input type="checkbox" class='checkbox' name="selecteur_coffre_exterieur" <? if($selecteur_coffre_exterieur==1) echo "checked='yes'" ?> value="1">Coffre Exterieur</td>
   </tr>
   <tr>
      <td></td>
      <td></td>
      ...
      <td></td>
      <td class="requet_left"><input type="checkbox" class='checkbox' name="selecteur_coffre_interieur" <? if($selecteur_coffre_interieur==1) echo "checked='yes'" ?>value="1">Coffre Interieur</td>
   </tr>
   ...
   <tr>
      ...
      <td></td>
      <td class="requet_left"><input type="checkbox" class='checkbox' name="selecteur_film_interieur" <? if($selecteur_film_interieur==1) echo "checked='yes'" ?>value="1">Film Interieur</td>
   </tr>
