...
?>
      <tr id="<? echo $z * 100?>">
         <?
               $bgcolor=alternat($z);	
         ?>
               <td class='resultat_list' bgcolor='<? echo alternat($z) ?>'><a class='resultat' href='incompatibilite_surface_detail.php?Id_incompatibilite=<? echo $resultat->f('Id_incompatibilite') ?>' target='droite'><? echo $resultat->f('Produit') ?></a></td>
...
if($z){
   ...
   echo "<tr>";
   echo"<td class='resultat_footer' colspan='8'>Cliquer sur le produit pour ouvrir une incompatibilité</td>";
