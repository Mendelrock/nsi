...
<?php include_once 'include_import_export_incomp_rapport.php'; ?>

<form method="post" name ="toile" action="incompatibilite_rapport_list_result.php?ACTE=1" target="resultat">
         ...
         <table class="menu_haut">
            <tr>
               ...
               <? if(droit_utilisateur("toile")){
                   echo "<td class='externe'><A class='externe' href='incompatibilite_rapport_detail.php'>Créer un rapport</A></td>";
                  }
                ?>
            </tr>
         </table>
